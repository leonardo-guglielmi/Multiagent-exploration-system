...
NUM_OF_SAMPLES = 25  # number of points each agent generates as potentially new positions (default: 250)
...
NUM_OF_ITERATIONS = 10  # max num of iterations before the algorithm stops (default: 100)
