...
NUM_OF_SAMPLES = 250  # number of points each agent generates as potentially new positions (default: 250)
...
NUM_OF_ITERATIONS = 100  # max num of iterations before the algorithm stops (default: 100)
...
EXPLORATION_REGION_WIDTH = 20
EXPLORATION_REGION_HEIGTH = 20
AREA_WIDTH = 1000
AREA_LENGTH = 1000
